...
function useIsDarkMode() {
  return Belt_Option.map(Caml_option.nullable_to_opt(ReactNative.useColorScheme()), (function (scheme) {
                return scheme === "dark";
              }));
}
  ...
  return React.createElement(ReactNative.View, {
              ...
              children: null
                  ...
                  style: [
                    styles.sectionTitle,
                    {
                      color: Belt_Option.getWithDefault(isDarkMode, false) ? NewAppScreen.Colors.white : NewAppScreen.Colors.black
                    }
                  ]
                }), React.createElement(ReactNative.Text, {
                  children: children,
...
function App$app(Props) {
  ...
  return React.createElement(ReactNative.SafeAreaView, {
              children: null
                  ...
                  barStyle: Belt_Option.getWithDefault(isDarkMode, false) ? "light-content" : "dark-content"
                }), React.createElement(ReactNative.ScrollView, {
                  contentInsetAdjustmentBehavior: "automatic",
                  style: {
                    backgroundColor: Belt_Option.getWithDefault(isDarkMode, false) ? NewAppScreen.Colors.darker : NewAppScreen.Colors.lighter
                  },
                  children: null
                }, React.createElement(NewAppScreen.Header, {}), React.createElement(App$Section, {
                      title: "Step One ( This is rescript file)",
                      children: null
                    ...
                    }), React.createElement(App$Section, {
                      title: "Debug",
